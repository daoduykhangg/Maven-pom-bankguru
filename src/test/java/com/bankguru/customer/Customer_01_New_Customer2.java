...
public class Customer_01_New_Customer2 extends AbstractTest{
	
	@Parameters({"browser", "url", "ip_address", "portNumber"})
	@BeforeClass
	public void beforeClass(String browserName, String urlValue, String ipAddress, String portNumber) {
		driver = getBrowserDriver(browserName, urlValue, ipAddress, portNumber);
