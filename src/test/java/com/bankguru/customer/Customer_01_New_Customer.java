...
public class Customer_01_New_Customer extends AbstractTest{
	...
	public void TC_01_Name_Can_Not_Be_Empty() {
		...
		newCustomerPage.sendKeyBoardToElement(driver, AbstractPageUI.DYNAMIC_TEXTBOX_BY_NAME, Keys.TAB, "name");
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, ""), "Customer name must not be blank");
	}
	...
	public void TC_02_Name_Can_Not_Be_Numberic() {
		...
		newCustomerPage.enterToTextboxByName(driver, "123", "name");
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, ""), "Numbers are not allowed");
	}
	...
	public void TC_03_Name_Can_Not_Have_Special_Characters() {
		...
		newCustomerPage.enterToTextboxByName(driver, "!@#", "name");
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, ""), "Special characters are not allowed");
	}
	...
	public void TC_04_Name_Can_Not_Have_First_Characters_As_Blank_Space() {
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, ""), "First character can not have space");
	}
	...
	public void TC_05_Address_Can_Not_Be_Empty() {
		...
		newCustomerPage.clickToTextareaByName(driver, "addr");
		
		log.info("New customer [Address cannot be empty] - Step 03: Enter to 'Address' with value 'TAB' key");
		newCustomerPage.sendKeyBoardToElement(driver, AbstractPageUI.DYNAMIC_TEXTAREA_BY_NAME, Keys.TAB, "addr");
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, "3"), "Address Field must not be blank");
	}
	...
	public void TC_06_Address_Can_Not_Have_First_Characters_As_Blank_Space() {
		...
		newCustomerPage.enterToTextareaByName(driver, " ", "addr");
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, "3"), "First character can not have space");
	}
	...
	public void TC_07_City_Can_Not_Be_Empty() {
		...
		newCustomerPage.sendKeyBoardToElement(driver, AbstractPageUI.DYNAMIC_TEXTBOX_BY_NAME, Keys.TAB, "city");
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, "4"), "City Field must not be blank");
	}
	...
	public void TC_08_City_Can_Not_Be_Numberic() {
		...
		newCustomerPage.enterToTextboxByName(driver, "123", "city");
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, "4"), "Numbers are not allowed");
	}
	...
	public void TC_09_City_Can_Not_Have_Special_Characters() {
		...
		newCustomerPage.enterToTextboxByName(driver, "!@#", "city");
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, "4"), "Special characters are not allowed");
	}
	...
	public void TC_10_City_Can_Not_Have_First_Characters_As_Blank_Space() {
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, "4"), "First character can not have space");
	}
	...
	public void TC_11_State_Can_Not_Be_Empty() {
		...
		newCustomerPage.sendKeyBoardToElement(driver, AbstractPageUI.DYNAMIC_TEXTBOX_BY_NAME, Keys.TAB, "state");
		
		log.info("New customer [State cannot be empty] - Step 04: Verify Error message is displayed with value 'State must not be blank'");
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, "5"), "State must not be blank");
	}
	...
	public void TC_12_State_Can_Not_Be_Numberic() {
		...
		newCustomerPage.enterToTextboxByName(driver, "123", "state");
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, "5"), "Numbers are not allowed");
	}
	...
	public void TC_13_State_Can_Not_Have_Special_Characters() {
		...
		newCustomerPage.enterToTextboxByName(driver, "!@#", "state");
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, "5"), "Special characters are not allowed");
	}
	...
	public void TC_14_State_Can_Not_Have_First_Characters_As_Blank_Space() {
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, "5"), "First character can not have space");
	}
	...
	public void TC_15_PIN_must_be_numberic() {
		...
		newCustomerPage.enterToTextboxByName(driver, "123PIN", "pinno");
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, "6"), "Characters are not allowed");
	}
	...
	public void TC_16_PIN_Can_Not_Be_Empty() {
		...
		newCustomerPage.sendKeyBoardToElement(driver, AbstractPageUI.DYNAMIC_TEXTBOX_BY_NAME, Keys.TAB, "pinno");
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, "6"), "PIN Code must not be blank");
	}
	...
	public void TC_17_PIN_Must_Have_6_Digits() {
		...
		newCustomerPage.enterToTextboxByName(driver, "123", "pinno");
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, "6"), "PIN Code must have 6 Digits");
	}
	...
	public void TC_18_PIN_Can_Not_Have_Special_Characters() {
		...
		newCustomerPage.enterToTextboxByName(driver, "!@#", "pinno");
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, "6"), "Special characters are not allowed");
	}
	...
	public void TC_19_PIN_Can_Not_Have_First_Characters_As_Blank_Space() {
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, "6"), "First character can not have space");
	}
	...
	public void TC_20_PIN_Can_Not_Have_Space() {
		...
		newCustomerPage.enterToTextboxByName(driver, "123 123", "pinno");
	...
	public void TC_21_Mobile_Number_Can_Not_Be_Empty() {
		...
		newCustomerPage.sendKeyBoardToElement(driver, AbstractPageUI.DYNAMIC_TEXTBOX_BY_NAME, Keys.TAB, "telephoneno");
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, "7"), "Mobile no must not be blank");
	}
	...
	public void TC_22_Mobile_Number_Can_Not_Have_First_Characters_As_Blank_Space() {
		...
		newCustomerPage.enterToTextboxByName(driver, " 123", "telephoneno");
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, "7"), "First character can not have space");
	}
	...
	public void TC_23_Mobile_Number_Can_Not_Have_Space() {
		...
		newCustomerPage.enterToTextboxByName(driver, "123 123", "telephoneno");
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, "7"), "Characters are not allowed");
	}
	...
	public void TC_24_Mobile_Number_Can_Not_Special_Characters() {
		...
		newCustomerPage.enterToTextboxByName(driver, "093*66!$5!", "telephoneno");
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, "7"), "Special characters are not allowed");
	}
	...
	public void TC_25_Email_Can_Not_Be_Empty() {
		...
		newCustomerPage.sendKeyBoardToElement(driver, AbstractPageUI.DYNAMIC_TEXTBOX_BY_NAME, Keys.TAB, "emailid");
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, "9"), "Email-ID must not be blank");
	}
	...
	public void TC_26_Email_Must_Be_Incorrect_format() {
		...
		newCustomerPage.enterToTextboxByName(driver, "guru99@gmail", "emailid");
		...
		verifyEquals(newCustomerPage.getErrorMessageValueByID(driver, "9"), "Email-ID is not valid");
	}
	@Test
	...
	public void TC_28_Check_All_Fields_Name_Are_As_Requirement() {
		...
		verifyTrue(newCustomerPage.isFieldNameDisplayed(driver, "Customer Name"));
		verifyTrue(newCustomerPage.isFieldNameDisplayed(driver, "Gender"));
		verifyTrue(newCustomerPage.isFieldNameDisplayed(driver, "Date of Birth"));
		verifyTrue(newCustomerPage.isFieldNameDisplayed(driver, "Address"));
		verifyTrue(newCustomerPage.isFieldNameDisplayed(driver, "City"));
		verifyTrue(newCustomerPage.isFieldNameDisplayed(driver, "State"));
		verifyTrue(newCustomerPage.isFieldNameDisplayed(driver, "PIN"));
		verifyTrue(newCustomerPage.isFieldNameDisplayed(driver, "Mobile Number"));
		verifyTrue(newCustomerPage.isFieldNameDisplayed(driver, "E-mail"));
		verifyTrue(newCustomerPage.isFieldNameDisplayed(driver, "Password"));
	}
